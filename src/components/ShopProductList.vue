    ...
    data(){
        return{
            products:[
                ...
                {
                    pic: "./assets/img/s9.jpg",
                    name: "Red Gajor",
                    discount: 'SALE!',
                    price: 29,
                },
                {
                    pic: "./assets/img/s10.jpg",
                    name: "organic letus",
                    discount: '',
                    price: 23,
                },
...
<template>
    <div class="container-one">
        <div class="container-two">
            ...
            <div class="products">
                <!-- TODO: mettere il prezzo scontato -->
...
.container-one{
    margin-top: 5rem;
    background-image: url('../components/assets/img/shop-bg-img.jpg');
    .container-two{
        padding: 2rem 0;
        text-align: center;
        color: white;
